...
/// Extension that adds string-specific methods to reactive String variables.
///
/// This extension provides all the standard String methods and operators
/// for reactive String variables, allowing you to work with them just like
/// regular strings while maintaining reactive behavior.
///
/// Example:
/// ```dart
...
///
/// // Use string methods
/// print(name.value.toUpperCase()); // HELLO
/// print(name.value.length);       // 5
///
/// // String operations
/// final greeting = name + ' World'; // 'Hello World'
/// ```
extension RxStringExt on Rx<String> {
  /// Concatenates this reactive string with another string.
  ///
  /// Returns a new string that is the concatenation of this reactive
  /// string's value and the provided string.
  String operator +(String val) => value + val;

  /// Compares this reactive string with another string.
  ///
  /// Returns a negative integer if this string is lexicographically
  /// less than [other], zero if they are equal, and a positive integer
  /// if this string is lexicographically greater than [other].
